...
class LoraPatches:
    """Class to manage LoRA patches for various PyTorch neural network components."""
    ...
    def undo(self) -> None:
        ...
        self.GroupNorm_forward = patches.undo(
            __name__, 
            torch.nn.GroupNorm, 
            'forward'
        )
        ...
        self.LayerNorm_forward = patches.undo(
            __name__, 
            torch.nn.LayerNorm, 
            'forward'
        )
